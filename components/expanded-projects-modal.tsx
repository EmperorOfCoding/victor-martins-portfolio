                ...
                {featuredProjects.map((project, index) => (
                  ...
                  >
                    ...
                    <div className="relative h-32 sm:h-40 md:h-48 bg-gradient-to-br from-primary/20 to-accent/10 overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-background/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4 sm:gap-6">
                        <a
                          href={project.github}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="p-2 sm:p-3 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-colors"
